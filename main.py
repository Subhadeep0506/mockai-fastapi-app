from core.vault_manager.infisical import InfisicalManagedCredentials
from dotenv import load_dotenv

_ = load_dotenv()
_infisical = InfisicalManagedCredentials()
is_secrets_loaded = _infisical()
if not is_secrets_loaded:
    sys.exit(0)
